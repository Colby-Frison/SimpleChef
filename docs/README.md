...
This folder contains project documentation used for implementation, course deliverables, and review.
...
- `CONTINUATION_CHECKLIST.md`: shipped status, deferred items, and backlog.
- `BACKEND_REFINEMENT_NOTES.md`: maintainability-focused backend refactor notes.
- `sample_recipes.md`: source links used for demo recipe seeding references.
